...
(function($) {
  ...
  asyncTest("navigating backward and forward should include the history state", function() {
    ...
    $.testHelper.eventSequence("navigate", [function(timedOut, data) {
      $.mobile.navigate("#foo", {
        foo: "bar"
      });
  ...
  asyncTest("navigation back to a duplicate history state should prefer back", function() {
    ...
    $.testHelper.eventSequence("navigate", [function() {
      $.mobile.navigate("#foo");
    }, function() {
      $.mobile.navigate("#bar");
    }, function() {
  ...
  asyncTest("Entries with identical URLs are distinguishable when pushState is enabled", function() {
    $.testHelper.eventSequence("navigate", [function() {
      $.mobile.navigate("#foo");
    }, function() {
      $.mobile.navigate("#bar");
