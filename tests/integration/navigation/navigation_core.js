...
(function($) {
  ...
  test("urlHistory is working properly", function() {
    ...
    $.mobile.navigate.history.stack[2] = {
      url: "shizoo",
      transition: "shizaah"
    };
  ...
  test("data url works for nested paths", function() {
    ...
    testDataUrlHash("#nested-data-url a", {
      hashOrPush: home + url
    });
  });
  ...
  test("data url works for single quoted paths and roles", function() {
    ...
    testDataUrlHash("#single-quotes-data-url a", {
      hashOrPush: home + url
    });
  });
  ...
  test("data url works when role and url are reversed on the page element", function() {
    ...
    testDataUrlHash("#reverse-attr-data-url a", {
      hashOrPush: home + url
    });
  });
