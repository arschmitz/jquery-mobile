  ...
  asyncTest("Event sequence during navigation to another page", function() {
    ...
    var otherPageUrl = makeOtherPageUrl("other-page.html"),
      expectedEventSequence = [
        ...
        // Valid
        {
          type: "pagecontainerbeforechange",
          target: "the-body",
          data: {
            prevPage: "start-page",
            nextPage: undefined,
        ...
        // Valid
        {
          type: "pagecontainerbeforetransition",
          target: "the-body",
          data: {
            prevPage: "start-page",
            nextPage: undefined,
