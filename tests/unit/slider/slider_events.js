...
(function($) {
  ...
  asyncTest("moving the slider triggers 'slidestart' and 'slidestop' events", function() {
    ...
    $.testHelper.eventCascade([function() {
